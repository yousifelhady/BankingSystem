...
public class Client 
{
    ...
    public static void checkServerMessage(String msg, DataInputStream dis, DataOutputStream dos)
    {
        ...
        else if(msg=="username?passowrd?deposit?") // sign up
        {
            state = 2;
            System.out.println("Enter Username, Password, Deposit");
        }
        else if(msg=="username?passowrd?") //sign in
        {
            state = 3;
        ...
        else if(msg=="notverifiednew")// error while creating new account
        {
            state = 2;
            System.out.println("ERROR try again!");
            System.out.println("Enter Username, Password, Deposit");
        }
        else if(msg=="notverifiedlogin") // error while sign in
        {
            state = 3;
            System.out.println("ERROR try again!");
            System.out.println("Enter Username, Password");
        ...
        else if(msg=="amount?") // option 2 deposit
        {
            state = 6;
           System.out.println("Please enter the amount");
        }
        else if(msg=="amountw?") // option 3 withdraw
        {
            state = 7;
            System.out.println("Please enter the amount");
        }
        else if(msg=="amount?account?") // transfer within same bank 
        {
            state = 8;
        ...
        else if(msg=="bankname?amount?account?") // option 5 transfer to another bank
        {
            state = 9;
